const quizPython = [
  ...
  {
    question:
      "Quelle est la méthode pour ajouter un élément à la fin d'une liste en Python ?",
    options: [".add()", ".push()", ".append()", ".insert()"],
    answer: 2,
  },
  {
    question:
      "Quelle fonction est utilisée pour lire une entrée de l'utilisateur en Python ?",
    options: ["input()", "get_input()", "read_input()", "user_input()"],
    answer: 0,
  },
  {
    question:
      "Quelle est la méthode pour supprimer le dernier élément d'une liste en Python ?",
...
function afficherLeQuiz(e) {
  submit.innerText = "Envoyer votre réponse";
  labels.forEach((e) => {
    e.style.display = "flex";
  });
  let prof = document.querySelector("small");
